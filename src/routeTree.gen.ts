...
import { Route as AuthenticatedTableImport } from './routes/_authenticated/table'
...
const AuthenticatedPaginationsLazyImport = createFileRoute(
  '/_authenticated/paginations',
)()
...
const AuthenticatedPaginationsLazyRoute =
  AuthenticatedPaginationsLazyImport.update({
    id: '/paginations',
    path: '/paginations',
    getParentRoute: () => AuthenticatedRouteRoute,
  } as any).lazy(() =>
    import('./routes/_authenticated/paginations.lazy').then((d) => d.Route),
  )
...
const AuthenticatedTableRoute = AuthenticatedTableImport.update({
  id: '/table',
  path: '/table',
  getParentRoute: () => AuthenticatedRouteRoute,
} as any)
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_authenticated/table': {
      ...
      path: '/table'
      fullPath: '/table'
      preLoaderRoute: typeof AuthenticatedTableImport
    ...
    '/_authenticated/paginations': {
      id: '/_authenticated/paginations'
      path: '/paginations'
      fullPath: '/paginations'
      preLoaderRoute: typeof AuthenticatedPaginationsLazyImport
      parentRoute: typeof AuthenticatedRouteImport
    }
    '/_authenticated/': {
      id: '/_authenticated/'
...
interface AuthenticatedRouteRouteChildren {
  ...
  AuthenticatedPaginationsLazyRoute: typeof AuthenticatedPaginationsLazyRoute
...
const AuthenticatedRouteRouteChildren: AuthenticatedRouteRouteChildren = {
  ...
  AuthenticatedPaginationsLazyRoute: AuthenticatedPaginationsLazyRoute,
...
export interface FileRoutesByFullPath {
  ...
  '/paginations': typeof AuthenticatedPaginationsLazyRoute
...
export interface FileRoutesById {
  ...
  '/_authenticated/paginations': typeof AuthenticatedPaginationsLazyRoute
...
/* ROUTE_MANIFEST_START
{
  "routes": {
    ...
    "/_authenticated/table": {
      "filePath": "_authenticated/table.tsx",
    ...
    "/_authenticated/paginations": {
      "filePath": "_authenticated/paginations.lazy.tsx",
      "parent": "/_authenticated"
    },
    "/_authenticated/": {
